...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="addLinks">
        <div class="list-group">
            <a class="list-group-item active">
                <span class="h5 list-group-item-heading"><xsl:text>Links</xsl:text></span>
            </a>
            <div class="ds-option-set list-group">
                <a class="list-group-item ds-option">
                    <xsl:attribute name="href">
                        <xsl:text>https://library.cpu.edu.ph/about-bahandian</xsl:text>
                    </xsl:attribute>
                ...
                <a class="list-group-item ds-option" href="/disclaimer">
                    <xsl:text>Disclaimer</xsl:text>
                </a>
                <a class="list-group-item ds-option" href="http://subjectsplus.library.cpu.edu.ph/subjects/guide.php?subject=bfaqs"
                   target="_blank">
                    <xsl:text>FAQs</xsl:text>
                </a>
                <a class="list-group-item ds-option" href="https://library.cpu.edu.ph/tag/bahandian/"
                   target="_blank">
